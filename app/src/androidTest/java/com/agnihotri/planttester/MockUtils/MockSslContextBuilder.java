 ...
 */
public final class MockSslContextBuilder {
    static {
     ...
     */
    public MockSslContextBuilder(String hostName) {
...
//        KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance("RSA", "BC");
    ...
    private X509Certificate selfSignedCertificate(KeyPair keyPair) throws GeneralSecurityException {
        ...
        return generator.generateX509Certificate(keyPair.getPrivate(), "AndroidOpenSSL");
    }
